...
int main() {
    int choice, n, **pivot;
    double **A, *b, *x, *y, **L, **U, *x_exact, *delta_x, relative_error, *r, relative_remainder, **A_inv, cpu_time_used;
    clock_t start, end;
    ...
    AllocateMemory(n, &x, &y, &delta_x, &x_exact, &r, &L, &U, &pivot, &A_inv);
    ...
    FreeMemory(n, A, b, x, y, delta_x, x_exact, r, L, U, pivot, A_inv);
